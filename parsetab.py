...
_lr_productions = [
  ...
  ('programa -> lista_declaracoes corpo_principal','programa',2,'p_programa','parser.py',103),
  ('lista_declaracoes -> lista_declaracoes declaracao','lista_declaracoes',2,'p_lista_declaracoes','parser.py',107),
  ('lista_declaracoes -> empty','lista_declaracoes',1,'p_lista_declaracoes','parser.py',108),
  ('declaracao -> type_declaration_block','declaracao',1,'p_declaracao','parser.py',116),
  ('declaracao -> var_declaration_block','declaracao',1,'p_declaracao','parser.py',117),
  ('declaracao -> function_declaration','declaracao',1,'p_declaracao','parser.py',118),
  ('corpo_principal -> BEGIN lista_comandos END SEMI','corpo_principal',4,'p_corpo_principal','parser.py',122),
  ('lista_comandos -> lista_comandos comando','lista_comandos',2,'p_lista_comandos','parser.py',126),
  ('lista_comandos -> empty','lista_comandos',1,'p_lista_comandos','parser.py',127),
  ('comando -> atribuicao','comando',1,'p_comando','parser.py',135),
  ('comando -> return_statement','comando',1,'p_comando','parser.py',136),
  ('comando -> function_call SEMI','comando',2,'p_comando','parser.py',137),
  ('type_declaration_block -> TYPE type_definition_list','type_declaration_block',2,'p_type_declaration_block','parser.py',142),
  ('type_definition_list -> type_definition_list single_type_definition','type_definition_list',2,'p_type_definition_list','parser.py',146),
  ('type_definition_list -> single_type_definition','type_definition_list',1,'p_type_definition_list','parser.py',147),
  ('single_type_definition -> ID EQUAL_TO type_definition SEMI','single_type_definition',4,'p_single_type_definition','parser.py',152),
  ('type_definition -> array_type_definition','type_definition',1,'p_type_definition','parser.py',156),
  ('type_definition -> record_type_definition','type_definition',1,'p_type_definition','parser.py',157),
  ('array_type_definition -> ARRAY LBRACKET NUMERO RBRACKET OF tipo_specifier','array_type_definition',6,'p_array_type_definition','parser.py',161),
  ('record_type_definition -> RECORD field_list END','record_type_definition',3,'p_record_type_definition','parser.py',165),
  ('field_list -> field_list field_declaration','field_list',2,'p_field_list','parser.py',169),
  ('field_list -> empty','field_list',1,'p_field_list','parser.py',170),
  ('field_declaration -> ID COLON tipo_specifier SEMI','field_declaration',4,'p_field_declaration','parser.py',175),
  ('var_declaration_block -> VAR var_declaration_list','var_declaration_block',2,'p_var_declaration_block','parser.py',179),
  ('var_declaration_list -> var_declaration_list declaracao_var','var_declaration_list',2,'p_var_declaration_list','parser.py',183),
  ('var_declaration_list -> declaracao_var','var_declaration_list',1,'p_var_declaration_list','parser.py',184),
  ('declaracao_var -> ID COLON tipo_specifier SEMI','declaracao_var',4,'p_declaracao_var','parser.py',189),
  ('tipo_specifier -> INTEGER','tipo_specifier',1,'p_tipo_specifier','parser.py',193),
  ('tipo_specifier -> REAL','tipo_specifier',1,'p_tipo_specifier','parser.py',194),
  ('tipo_specifier -> STRING','tipo_specifier',1,'p_tipo_specifier','parser.py',195),
  ('tipo_specifier -> ID','tipo_specifier',1,'p_tipo_specifier','parser.py',196),
  ('atribuicao -> lvalue ATRIB expressao SEMI','atribuicao',4,'p_atribuicao','parser.py',201),
  ('lvalue -> ID','lvalue',1,'p_lvalue','parser.py',205),
  ('lvalue -> array_access','lvalue',1,'p_lvalue','parser.py',206),
  ('lvalue -> record_access','lvalue',1,'p_lvalue','parser.py',207),
  ('array_access -> ID LBRACKET expressao RBRACKET','array_access',4,'p_array_access','parser.py',211),
  ('record_access -> lvalue DOT ID','record_access',3,'p_record_access','parser.py',215),
  ('function_declaration -> DEF ID LPAREN params_opt RPAREN tipo_retorno_opt function_body','function_declaration',7,'p_function_declaration','parser.py',220),
  ('var_declarations_opt -> var_declaration_block','var_declarations_opt',1,'p_var_declarations_opt','parser.py',224),
  ('var_declarations_opt -> empty','var_declarations_opt',1,'p_var_declarations_opt','parser.py',225),
  ('function_body -> var_declarations_opt BEGIN lista_comandos END SEMI','function_body',5,'p_function_body','parser.py',229),
  ('return_statement -> RETURN expressao SEMI','return_statement',3,'p_return_statement','parser.py',233),
  ('params_opt -> params','params_opt',1,'p_params_opt','parser.py',237),
  ('params_opt -> empty','params_opt',1,'p_params_opt','parser.py',238),
  ('params -> params COMMA param','params',3,'p_params','parser.py',242),
  ('params -> param','params',1,'p_params','parser.py',243),
  ('param -> ID COLON tipo_specifier','param',3,'p_param','parser.py',248),
  ('tipo_retorno_opt -> COLON COLON tipo_specifier','tipo_retorno_opt',3,'p_tipo_retorno_opt','parser.py',252),
  ('tipo_retorno_opt -> empty','tipo_retorno_opt',1,'p_tipo_retorno_opt','parser.py',253),
  ('expressao -> expressao PLUS expressao','expressao',3,'p_expressao','parser.py',259),
  ('expressao -> expressao MINUS expressao','expressao',3,'p_expressao','parser.py',260),
  ('expressao -> expressao TIMES expressao','expressao',3,'p_expressao','parser.py',261),
  ('expressao -> expressao DIVIDE expressao','expressao',3,'p_expressao','parser.py',262),
  ('expressao -> termo','expressao',1,'p_expressao_termo','parser.py',266),
  ('termo -> LPAREN expressao RPAREN','termo',3,'p_termo','parser.py',270),
  ('termo -> NUMERO','termo',1,'p_termo','parser.py',271),
  ('termo -> function_call','termo',1,'p_termo','parser.py',272),
  ('termo -> lvalue','termo',1,'p_termo','parser.py',273),
  ('function_call -> ID LPAREN args_opt RPAREN','function_call',4,'p_function_call','parser.py',282),
  ('args_opt -> args','args_opt',1,'p_args_opt','parser.py',286),
  ('args_opt -> empty','args_opt',1,'p_args_opt','parser.py',287),
  ('args -> args COMMA expressao','args',3,'p_args','parser.py',291),
  ('args -> expressao','args',1,'p_args','parser.py',292),
